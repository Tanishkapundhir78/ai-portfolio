...
export default function Projects() {
  ...
  const generateAI = (project, type) => {
    ...
    if (type === "recruiter") {
      return `🎯 ${project.title} is a real-world project focused on ${
        project.domain === "ml"
          ? "predictive modeling and data-driven decisions"
          : project.domain === "analytics"
          ? "business insights and dashboarding"
          : "AI-powered automation"
      }. It demonstrates strong problem-solving skills and hands-on experience with ${tech}.`;
    }

    if (type === "technical") {
      return `⚙️ This project is built using ${tech}. It includes ${
        project.domain === "ml"
          ? "data preprocessing, feature engineering, model training, and evaluation"
          : project.domain === "analytics"
          ? "data modeling, KPI tracking, and visualization techniques"
          : "LLM integration, prompt engineering, and system design"
    ...
    if (type === "impact") {
      return `📈 This project delivers impact by ${
        project.domain === "ml"
          ? "predicting future outcomes and reducing business risks"
          : project.domain === "analytics"
          ? "helping stakeholders make data-driven decisions"
          : "automating complex workflows and improving productivity"
      }. It reflects the ability to convert data into actionable insights.`;
    }
  };
